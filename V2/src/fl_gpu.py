...
max_epochs, max_local_steps, max_global_aggregations, chosen_topology):
      ...
      self.comm_steps = 1 / local_steps #((self.total_m_batches_local + 1.0) - local_steps) / self.total_m_batches_local
      #self.communication_fitness = self.comm_quant * self.comm_n_devices * self.comm_thres * self.comm_steps
      self.communication_fitness = 0.5 * self.comm_steps * self.comm_n_devices + self.comm_quant * self.comm_n_devices * self.comm_thres * self.comm_steps * 0.5

      



      logging.info("self.comm_quant = " + str(self.comm_quant))
      logging.info("self.comm_n_devices = " + str(self.comm_n_devices))
      logging.info("self.comm_thres = " + str(self.comm_thres))
